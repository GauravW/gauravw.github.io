...
<!-- LEFT COLUMN CONTENT IS AUTOMATIC -->
...
My Ph.D. was supervised by [Varun Bhalerao](https://www.star-iitb.in/group/varun-bhalerao) at [STAR Lab](https://www.star-iitb.in/). During my Ph.D., I led the structural and thermal design of the proposed [Daksha](https://www.dakshasat.in/) satellite mission, studied high-energy transients with [AstroSat](https://www.isro.gov.in/AstroSat.html)-CZTI, and worked on low-latency gravitational-wave alerts with the [LIGO–Virgo–KAGRA](https://www.ligo.org/) collaboration. Earlier, as a B.Tech. student in Mechanical Engineering, I worked on astronomy projects across the electromagnetic spectrum (X-ray, optical, and radio), was part of the [IIT Bombay Racing](https://www.iitbracing.org/) team, building the gearbox & cooling of an electric race car, and was a part of [Krittika](https://www.instagram.com/krittika.iitb/). 

Insight-IITB covered my decade-long journey at IIT Bombay here: [link](https://insightiitb.org/gaurav-waratkar/).
